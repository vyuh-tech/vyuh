...
void main() {
  ...
  testWidgets('PortableText can be created with required parameters', (
    ...
    await tester.pumpWidget(const MaterialApp(home: PortableText(blocks: [])));
  ...
  testWidgets('PortableText correctly renders the blocks passed to it', (
    ...
    await tester.pumpWidget(MaterialApp(home: PortableText(blocks: blocks)));
  ...
  testWidgets('PortableTextConfig applies configuration correctly', (
    ...
    await widgetTester.pumpWidget(
      MaterialApp(
        home: PortableText(
          blocks: [
            TextBlockItem(children: [Span(text: 'Hello')]),
          ],
        ),
      ),
    );
    ...
    expect(
      PortableTextConfig.shared.itemPadding,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final blocks = [
        TextBlockItem(children: [Span(text: 'Hello, World')]),
      ];
      ...
      expect(
        findTextSpan(
          (span) =>
              ...
              span.style?.fontSize ==
                  PortableTextConfig.defaultBaseStyle(
  ...
  testWidgets('PortableTextBlock applies itemPadding correctly', (
    ...
    final block = TextBlockItem(children: [Span(text: 'Hello, World')]);

    await tester.pumpWidget(MaterialApp(home: PortableTextBlock(model: block)));
