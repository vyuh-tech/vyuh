...
class TestExtensionBuilder extends ExtensionBuilder<ExtensionDescriptor> {
  TestExtensionBuilder({required super.title})
...
void main() {
  group('VyuhPlatform', () {
      ...
      runApp(
        features: () => [
          ...
          FeatureDescriptor(
            ...
            routes: () => [
              GoRoute(path: '/test2', builder: (_, _) => const SizedBox()),
            ],
          ),
        ],
      );
        ...
        features: () => [
          FeatureDescriptor(
            ...
            routes: () {
              ...
              return [GoRoute(path: '/', builder: (_, _) => const SizedBox())];
            },
          ),
        ],
      );
      ...
      runApp(
        features: () => [
          FeatureDescriptor(
            ...
            title: 'Test',
            routes: () => [
              GoRoute(path: initialPath, builder: (_, _) => const SizedBox()),
            ],
          ),
        ],
    ...
    testWidgets('handles extensions and extension builders', (tester) async {
      ...
      final mockBuilder = TestExtensionBuilder(title: 'Test Extension Builder');
    ...
    testWidgets('caches route builder results', (tester) async {
      ...
      final routes = [GoRoute(path: '/', builder: (_, _) => const SizedBox())];
    ...
    group('Extension System', () {
      testWidgets('handles multiple extensions of same type', (tester) async {
        final extensions = List.generate(3, (i) => TestExtensionDescriptor());
        var initCallCount = 0;

        final builder = TestExtensionBuilder(title: 'Test Extension Builder');
      ...
      testWidgets('handles extension builder disposal errors', (tester) async {
    ...
    group('Error Handling', () {
      ...
      testWidgets('handles route builder errors', (tester) async {
        ...
        await vyuh.getReady(tester);
        expect(vyuh.tracker.error, isNotNull);
        expect(vyuh.tracker.error.toString(), contains('Route builder error'));
      });
