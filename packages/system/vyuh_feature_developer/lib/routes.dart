  ...
  Widget detailsView(BuildContext context) {
    ...
    switch (this) {
      case AnalyticsPlugin():
        return AnalyticsPluginDetail(plugin: plugin as AnalyticsPlugin);
      case TelemetryPlugin():
        return TelemetryPluginDetail(plugin: plugin as TelemetryPlugin);
      case ContentPlugin():
        return ContentPluginDetailsView(plugin: plugin as ContentPlugin);
      default:
